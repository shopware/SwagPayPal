...
class ExpressShippingCallbackServiceTest extends TestCase
{
    ...
    public function testCalculationSwitchesToFirstAvailableWhenSelectedShippingMethodIsBlocked(): void
    {
        ...
        static::assertArrayHasKey(SalesChannelContextService::SHIPPING_METHOD_ID, $params);
        static::assertNotSame($blocked->getId(), $params[SalesChannelContextService::SHIPPING_METHOD_ID]);
    }
