...
class APMHandlerTest extends TestCase
{
    ...
    private function processPayment(string $orderId, Request $request, SalesChannelContext $context, APMHandler $apmHandler): RedirectResponse
    {
        ...
        $response = $apmHandler->pay($request, $struct, $context->getContext(), null);
    ...
    {
        $struct = new PaymentTransactionStruct($orderTransactionId, '');
        $apmHandler->finalize($request, $struct, $context->getContext());
    }
