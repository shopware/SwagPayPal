...
use Swag\PayPal\Test\IZettle\Webhook\_fixtures\TestMessageFixture;
...
class WebhookControllerTest extends TestCase
{
    ...
    {
        $this->getIZettleSalesChannel($this->salesChannel)->setWebhookSigningKey(null);
    ...
    public function testRegister(): void
    {
        ...
        static::assertSame(WebhookRegisterFixture::WEBHOOK_SIGNING_KEY, $this->getIZettleSalesChannel($this->salesChannel)->getWebhookSigningKey());
    }
    ...
    public function testUnregister(): void
    {
        ...
        static::assertNull($this->getIZettleSalesChannel($this->salesChannel)->getWebhookSigningKey());
    }
}
