    ...
    public function update(Connection $connection): void
    {
        $connection->executeUpdate('
            CREATE TABLE IF NOT EXISTS `swag_paypal_izettle_sales_channel_run_log` (
                ...
                KEY `fk.swag_paypal_izettle_sales_channel_run_log.product_id` (`product_id`),
                KEY `fk.swag_paypal_izettle_sales_channel_run_log.product_vid` (`product_version_id`),
                ...
                CONSTRAINT `fk.swag_paypal_izettle_sales_channel_run_log.product` FOREIGN KEY (`product_id`, `product_version_id`) REFERENCES `product` (`id`, `version_id`) ON DELETE SET NULL ON UPDATE SET NULL
