...
class CreateCartRoute extends AbstractCreateCartRoute
{
    public function getDecorated(): AbstractCreateCartRoute
    {
        throw new DecorationPatternException(self::class);
    }

    #[Route('/api/paypal/v1/merchant-cart', name: 'api.paypal.merchant-cart', methods: [Request::METHOD_POST])]
    public function createCart(Request $request, Context $context): PayPalAgentCartResponse
    {
        ...
        return new PayPalAgentCartResponse('new-cart-token');
    }
}
