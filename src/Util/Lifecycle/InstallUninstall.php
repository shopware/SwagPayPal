...
{
    /**
     * @deprecated tag:v5.0.0 - has been moved to \Swag\PayPal\Util\Lifecycle\Method\PayPalPuiMethodData::PAYPAL_PUI_AVAILABILITY_RULE_NAME and set to private. will be removed here.
     */
