...
use Swag\PayPal\AgenticCommerce\Struct\V1\Context\AbstractContext;
use Swag\PayPal\AgenticCommerce\Struct\V1\Context\BusinessRuleErrorContext;
use Swag\PayPal\AgenticCommerce\Struct\V1\Context\DataErrorContext;
use Swag\PayPal\AgenticCommerce\Struct\V1\Context\InventoryIssueContext;
use Swag\PayPal\AgenticCommerce\Struct\V1\Context\PaymentErrorContext;
use Swag\PayPal\AgenticCommerce\Struct\V1\Context\PricingErrorContext;
use Swag\PayPal\AgenticCommerce\Struct\V1\Context\ShippingErrorContext;
