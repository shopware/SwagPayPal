...
use Swag\PayPal\AgenticCommerce\Struct\V1\Value\AgeVerificationValue;
use Swag\PayPal\AgenticCommerce\Struct\V1\Value\AllergyInformationValue;
use Swag\PayPal\AgenticCommerce\Struct\V1\Value\CustomEngravingTextValue;
use Swag\PayPal\AgenticCommerce\Struct\V1\Value\CustomSizingInfoValue;
use Swag\PayPal\AgenticCommerce\Struct\V1\Value\DeliveryDatePreferenceValue;
use Swag\PayPal\AgenticCommerce\Struct\V1\Value\DeliveryInstructionsValue;
use Swag\PayPal\AgenticCommerce\Struct\V1\Value\GiftMessageValue;
use Swag\PayPal\AgenticCommerce\Struct\V1\Value\GiftRecipientEmailValue;
use Swag\PayPal\AgenticCommerce\Struct\V1\Value\GiftRecipientNameValue;
use Swag\PayPal\AgenticCommerce\Struct\V1\Value\PrivacyConsentValue;
use Swag\PayPal\AgenticCommerce\Struct\V1\Value\TermsAcceptanceValue;
