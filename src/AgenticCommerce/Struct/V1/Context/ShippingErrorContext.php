...
use Swag\PayPal\AgenticCommerce\Struct\V1\Referral\SuggestedCorrection;
use Swag\PayPal\AgenticCommerce\Struct\V1\Referral\SuggestedCorrectionCollection;
