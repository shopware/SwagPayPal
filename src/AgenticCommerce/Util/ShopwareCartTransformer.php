...
use Swag\PayPal\AgenticCommerce\Struct\V1\Coupon;
use Swag\PayPal\AgenticCommerce\Struct\V1\CouponCollection;
use Swag\PayPal\AgenticCommerce\Struct\V1\Customer;
use Swag\PayPal\AgenticCommerce\Struct\V1\PayPalCart;
use Swag\PayPal\AgenticCommerce\Struct\V1\Phone;
use Swag\PayPal\AgenticCommerce\Struct\V1\Referral\CustomerName;
