 ...
 */
#[Package('checkout')]
#[Route(defaults: ['_routeScope' => [AgentRouteScope::ID], '_agentScope' => [AgentSource::SCOPE_CHECKOUT]])]
class CheckoutRoute extends AbstractAgenticCommerceRoute
{
    ...
    public function checkout(string $token, Request $request, SalesChannelContext $context): AgentCartResponse
    {
        ...
        // @deprecated tag:v11.0.0 - remove if condition with min-version of v6.7.1.0
