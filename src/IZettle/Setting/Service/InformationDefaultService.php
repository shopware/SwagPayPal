...
use Swag\PayPal\IZettle\Payment\IZettlePayment;
use Swag\PayPal\IZettle\Setting\Exception\CustomerGroupNotFoundException;
use Swag\PayPal\IZettle\Setting\Struct\AdditionalInformation;
use Swag\PayPal\SwagPayPal;

class InformationDefaultService
{
    public const IZETTLE_PAYMENT_METHOD_ID = 'abab06a108014a37b5f49c9a4d8943db';
    public const IZETTLE_SHIPPING_METHOD_ID = '405481da0a20443e94ce45f52b1af776';
    ...
    {
        $criteria = new Criteria([self::IZETTLE_PAYMENT_METHOD_ID]);
        $criteria->addFilter(new EqualsFilter('handlerIdentifier', IZettlePayment::class));
        ...
        $this->paymentMethodRepository->upsert([[
            'id' => self::IZETTLE_PAYMENT_METHOD_ID,
            'handlerIdentifier' => IZettlePayment::class,
            'active' => false,
            'position' => 999,
            'name' => 'iZettle',
            'pluginId' => $pluginId,
        ...
        return self::IZETTLE_PAYMENT_METHOD_ID;
    }

    private function getShippingMethodId(Context $context): string
    {
        $criteria = new Criteria([self::IZETTLE_SHIPPING_METHOD_ID]);
        ...
        $this->shippingMethodRepository->create([[
            'id' => self::IZETTLE_SHIPPING_METHOD_ID,
            'active' => false,
        ...
        return self::IZETTLE_SHIPPING_METHOD_ID;
    }
