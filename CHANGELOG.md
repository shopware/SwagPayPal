...
- Fixes an issue, where the Express Checkout prepare step failed with an uninitialized `Shipping::$name` typed-property (shopware/shopware#16295).
...
- PPI-1070 - Improved locale fallback behaviour
