...
- Behebt ein Problem, bei dem der Vorbereitungs-Schritt des Express Checkout mit einer nicht initialisierten getypten Eigenschaft `Shipping::$name` fehlschlug (shopware/shopware#16295).
